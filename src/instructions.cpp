...
void fillInstructionSet(Instructions::Set& set) {
        ...
        if(useConstantInstruction){
            ...
            set.add(*(new Instructions::LambdaInstruction<double, double, Data::Constant, Data::Constant>(minusC, "$0 = $1 * $3 - $2 * $4;")));
            set.add(*(new Instructions::LambdaInstruction<double, double, Data::Constant, Data::Constant>(addC, "$0 = $1 * $3 + $2 * $4;")));
            set.add(*(new Instructions::LambdaInstruction<double, double, Data::Constant>(multC, "$0 = $1 * $2 * $3;")));
            set.add(*(new Instructions::LambdaInstruction<double, double, Data::Constant>(divC, "$0 = $1 / $2 * $3;")));
            //set.add(*(new Instructions::LambdaInstruction<double, double>(max, "$0 = (($1) < ($2)) ? ($2) : ($1);")));
            set.add(*(new Instructions::LambdaInstruction<double, Data::Constant>(expC, "$0 = exp($1 * $2);")));
            set.add(*(new Instructions::LambdaInstruction<double, Data::Constant>(lnC, "$0 = log($1 * $2);")));
            set.add(*(new Instructions::LambdaInstruction<double, Data::Constant>(cosC, "$0 = cos($1 * $2);")));
            set.add(*(new Instructions::LambdaInstruction<double, Data::Constant>(sinC, "$0 = sin($1 * $2);")));
            set.add(*(new Instructions::LambdaInstruction<double, Data::Constant>(tanC, "$0 = tan($1 * $2);")));
        }
